...
import useCartStore from "../model/useCartStore.js";
import { createPayLinkProduct } from "@/shared/utils/paylink.js";
...
export default function CartSummary() {
  ...
  const handlePayLinkCheckout = async () => {
    ...
    try {
      const cartData = {
        ...
        totalItems,
        items: cartItems,
        contactData: { phone: contactData.phone, email: contactData.email },
      };
      ...
      showNotification(
        error.message || "Произошла ошибка при создании ссылки оплаты. Попробуйте еще раз.",
        "error"
      );
    } finally {
  ...
  return (
    <>
      ...
      {notification && (
        <div className="fixed top-4 right-4 max-w-sm w-full" style={{ zIndex: 999999 }}>
          <div
