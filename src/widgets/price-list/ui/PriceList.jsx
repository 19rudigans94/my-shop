  ...
  useEffect(() => {
    const fetchPrices = async () => {
      try {
        ...
        const digitalResponse = await fetch(`/api/games/${params.slug}/digital`);
        ...
        if (Array.isArray(digitalData?.copies)) {
          setDigitalInfo({
            ...
            platform: digitalData.copies.length > 0 ? digitalData.copies[0].platform : "",
            price: digitalData.copies.length > 0 ? digitalData.copies[0].price : 0,
                    ...
                    ?.variants.map((variant) => (
                      ...
                      >
                        <div className="w-40 text-center">
                          ...
                          <div className="text-2xl font-bold mb-1">{variant.price} ₸</div>
                          <div
                            className={`text-xs ${
                              variant.stock > 0
