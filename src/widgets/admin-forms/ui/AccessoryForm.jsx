...
const ACCESSORY_PLATFORMS = ["PS5", "PS4"];
    ...
    if (accessory) {
      setFormData({
        ...
        images: Array.isArray(accessory.images)
          ? accessory.images
          : accessory.image
          ? [{ url: accessory.image, thumbUrl: accessory.image, filename: "", alt: "", size: 0, width: 0, height: 0, uploadedAt: new Date() }]
          : [],
      });
    }
  }, [accessory]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          >
            ...
            {ACCESSORY_PLATFORMS.map((platform) => (
