...
export default function FixedModal({ isOpen, closeModal, total, onSuccess }) {
  ...
  return (
    ...
    >
      ...
      <Dialog.Panel className="w-full max-w-md p-6 my-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl z-10 relative">
        ...
        {isSuccess ? (
          ...
          <form onSubmit={handleSubmit}>
            <div className="mt-2 space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              ...
              <div className="pt-2">
                <div className="font-medium text-gray-700 dark:text-gray-300 mb-3 flex items-center">
